...
export class UppercaseAuditEntityTypes1716000000002 implements MigrationInterface {
  name = 'UppercaseAuditEntityTypes1716000000002';
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Backfill existing rows to uppercase entity types
    await queryRunner.query(`
